...
func (c *Callbacks) Create() *CallbacksProcessor {
	return &CallbacksProcessor{kind: CREATE_CALLBACK, parent: c}
}

// Update could be used to register callbacks for updating object, refer `Create` for usage
func (c *Callbacks) Update() *CallbacksProcessor {
	return &CallbacksProcessor{kind: UPDATE_CALLBACK, parent: c}
}

// Delete could be used to register callbacks for deleting object, refer `Create` for usage
func (c *Callbacks) Delete() *CallbacksProcessor {
	return &CallbacksProcessor{kind: DELETE_CALLBACK, parent: c}
}

// Query could be used to register callbacks for querying objects with query methods like `Find`, `First`, `Related`, `Association`...
// Refer `Create` for usage
func (c *Callbacks) Query() *CallbacksProcessor {
	return &CallbacksProcessor{kind: QUERY_CALLBACK, parent: c}
}

// RowQuery could be used to register callbacks for querying objects with `Row`, `Rows`, refer `Create` for usage
func (c *Callbacks) RowQuery() *CallbacksProcessor {
	return &CallbacksProcessor{kind: ROW_QUERY_CALLBACK, parent: c}
}
